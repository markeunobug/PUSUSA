...
static volatile u16 rx_buffer[DMA_MAX_BYTES / sizeof(u16)] __attribute__((aligned(32)));
...
u32 dma_capture_bytes_for_samples(u32 sample_count)
{
    return sample_count * DMA_STREAM_BYTES_PER_SAMPLE;
}
