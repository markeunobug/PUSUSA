...
typedef struct {
    ...
    unsigned char pl_mode_value;
    unsigned char pl_output_select;
    unsigned char pl_reserved;
    unsigned int pl_status;
    unsigned int pl_sample_rate_hz;
    unsigned int pl_decimation;
    unsigned int pl_frame_words;
    unsigned int pl_data_format;
    unsigned int pl_version;
    unsigned int pl_input_sample_count;
    unsigned int pl_output_sample_count;
    unsigned int pl_output_drop_count;
    unsigned int pl_error_code;
} device_status_t;
