...
void ltc2208_set_control(uint32_t mask, int level)
{
    ad8370_set_mask(mask, level);
}

void ltc2208_set_default_controls(void)
{
    ltc2208_set_control(LTC2208_PGA_MASK, 0);
    ltc2208_set_control(LTC2208_SHDN_MASK, 0);
    ltc2208_set_control(LTC2208_DITH_MASK, 0);
    ltc2208_set_control(LTC2208_RAND_MASK, 0);
}
