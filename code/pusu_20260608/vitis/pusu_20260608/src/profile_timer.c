...
#define SWEEP_PROFILE_HEADER_LEN 24U
#define SWEEP_PROFILE_SECTION_LEN 30U
                                ...
                                unsigned short *out_len)
{
    ...
    const unsigned int total_len =
        SWEEP_PROFILE_HEADER_LEN +
        (unsigned int)SWEEP_PROFILE_SECTION_COUNT * SWEEP_PROFILE_SECTION_LEN;
