...
module adc_capture_control_axi #(
    ...
    parameter [31:0]  VERSION            = 32'h20260608
)(
    ...
    input  wire                              status_burst_active,
    input  wire                              status_burst_done,
    ...
    input  wire [31:0]                       status_burst_packet_count,
    input  wire [31:0]                       status_burst_remaining,
    ...
    localparam [3:0] REG_FRAME_COUNT           = 4'd13; // 0x34
    localparam [3:0] REG_BURST_PACKET_COUNT    = 4'd14; // 0x38
    localparam [3:0] REG_BURST_REMAINING       = 4'd15; // 0x3C

    localparam [1:0] AXI_RESP_OKAY = 2'b00;

    reg [15:0] frame_len_axi;
    reg [31:0] frame_count_axi;
    ...
    reg [31:0] frame_count_adc_meta;
    reg [31:0] frame_count_adc_sync;
    ...
    reg status_burst_active_axi_1;
    reg status_burst_active_axi_2;
    reg status_burst_done_axi_1;
    reg status_burst_done_axi_2;
    ...
    reg [31:0] burst_packet_count_axi_1;
    reg [31:0] burst_packet_count_axi_2;
    reg [31:0] burst_remaining_axi_1;
    reg [31:0] burst_remaining_axi_2;
    ...
    assign status_word_axi = {
        22'd0,
        status_burst_done_axi_2,
        status_burst_active_axi_2,
    ...
    function [31:0] read_register;
        ...
        begin
            case (reg_sel)
                ...
                REG_FRAME_COUNT:
                    read_register = frame_count_axi;
                REG_BURST_PACKET_COUNT:
                    read_register = burst_packet_count_axi_2;
                REG_BURST_REMAINING:
                    read_register = burst_remaining_axi_2;
            ...
            if (write_fire) begin
                ...
                case (write_reg_sel)
                    ...
                    REG_FRAME_COUNT: begin
                        frame_count_axi <= apply_wstrb(frame_count_axi,
                                                       write_data,
                                                       write_wstrb);
                    end
    ...
    always @(posedge s_axi_aclk) begin
        if (!s_axi_aresetn) begin
            ...
            status_burst_active_axi_1 <= 1'b0;
            status_burst_active_axi_2 <= 1'b0;
            status_burst_done_axi_1   <= 1'b0;
            status_burst_done_axi_2   <= 1'b0;
            ...
            burst_packet_count_axi_1    <= 32'd0;
            burst_packet_count_axi_2    <= 32'd0;
            burst_remaining_axi_1       <= 32'd0;
            burst_remaining_axi_2       <= 32'd0;
            ...
            status_burst_active_axi_1 <= status_burst_active;
            status_burst_active_axi_2 <= status_burst_active_axi_1;
            status_burst_done_axi_1   <= status_burst_done;
            status_burst_done_axi_2   <= status_burst_done_axi_1;
            ...
            burst_packet_count_axi_1    <= status_burst_packet_count;
            burst_packet_count_axi_2    <= burst_packet_count_axi_1;
            burst_remaining_axi_1       <= status_burst_remaining;
            burst_remaining_axi_2       <= burst_remaining_axi_1;
    ...
    always @(posedge adc_clk) begin
        if (!adc_rst_n) begin
            ...
            frame_count_adc_meta  <= 32'd0;
            frame_count_adc_sync  <= 32'd0;
            ...
            frame_count_adc_meta <= frame_count_axi;
            frame_count_adc_sync <= frame_count_adc_meta;
            ...
            capture_frame_count <= frame_count_adc_sync;
