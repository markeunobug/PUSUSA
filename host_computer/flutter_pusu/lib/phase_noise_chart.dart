        ...
        children: [
          ...
          material.Text(
            marker == null
                ...
                : 'Marker RBW ${_formatOffset(marker.rbwHz)}  ENBW ${_formatOffset(widget.config.effectiveEnbwHz)}',
            style: const material.TextStyle(
      ...
      child: material.Column(
        children: [
          ...
          material.Row(
            ...
            children: [
              material.Text(
                'Start ${_formatOffset(widget.minOffsetHz)}',
                style: const material.TextStyle(
              ...
              material.Text(
                'Stop ${_formatOffset(widget.maxOffsetHz)}',
                style: const material.TextStyle(
                  color: material.Color(0xFF77DD77),
                  fontSize: 12,
                ),
...
class PhaseNoiseCsvExporter {
  ...
  static String buildCsv({
    ...
    buffer.writeln(
        'enbw_mode,${config.enbwHz == null ? 'estimated' : 'calibrated'}');
    buffer.writeln('calibration_state,UNCAL');
