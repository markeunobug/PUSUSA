...
// -------------------------- GPIO引脚宏定义--------------------------
#define LMX2592_CE(x)        HAL_GPIO_WritePin(PLL_CE_GPIO_Port, PLL_CE_Pin, (x) ? GPIO_PIN_SET : GPIO_PIN_RESET)
#define LMX2592_CSB(x)       HAL_GPIO_WritePin(PLL_CSB_GPIO_Port, PLL_CSB_Pin, (x) ? GPIO_PIN_SET : GPIO_PIN_RESET)
#define LMX2592_SCLK(x)      HAL_GPIO_WritePin(PLL_SCL_GPIO_Port, PLL_SCL_Pin, (x) ? GPIO_PIN_SET : GPIO_PIN_RESET)
#define LMX2592_SDIO(x)      HAL_GPIO_WritePin(PLL_SDI_GPIO_Port, PLL_SDI_Pin, (x) ? GPIO_PIN_SET : GPIO_PIN_RESET)
#define LMX2592_MUX_READ()   HAL_GPIO_ReadPin(PLL_MUX_GPIO_Port, PLL_MUX_Pin)

// 状态指示灯宏
#define LED_LD(x)            HAL_GPIO_WritePin(LED_LD_GPIO_Port, LED_LD_Pin, (x) ? GPIO_PIN_SET : GPIO_PIN_RESET)
